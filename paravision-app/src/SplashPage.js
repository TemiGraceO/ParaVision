    ...
    <>
      ...
      <div className='first'>
        ...
        <div className="horizontal-layout">
          ...
          <div className="item" onClick={handlePatientClick}><svg width="44" height="30" viewBox="0 0 24 24" fill="none" stroke="#0d6efd" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
